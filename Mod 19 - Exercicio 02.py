...
# caixas de selecao, filtro no streamlit
...
def main():
    ...
    if (data_file_1 is not None):
        ...
        with st.sidebar.form(key='my_form'):
            ...
            num_linhas = st.slider('Quantas linhas da tabela filtrada gostaria de visualizar? (1 a 20)',
        ...
        st.write(bank.head(num_linhas))
        st.markdown("---")

        csv = df_toString(bank)
        st.write('### Download CSV')
        st.download_button(
            label="Download da tabela filtrada",
            data=csv,
